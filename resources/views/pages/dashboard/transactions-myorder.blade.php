            ...
            <div class="card-body">
              <div class="row">
                <div class="col-12 col-md-4">
                  <img src="" alt="" class="ws-100 mb-3 img-fluid" />
                </div>
                <div class="col-12 col-md-8">
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle"> $transaction->product->name
                      </div>
                    </div>
                    <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">Rp 12.0000</div>
                    </div>
                    <div class="col-12 col-md-6">
                  ...
                  <div class="col-12">
                    <div class="row">
                      ...
                      <div class="col-12 col-md-6">
                        ...
                        <div class="product-subtitle">$transaction->transaction->user->country
                        </div>
                      </div>
                      <div class="col-12 col-md-3">
                        <div class="product-title">Shipping Status</div>
                        <select name="shipping_status" id="status" class="form-select mt-1" v-model="status">
