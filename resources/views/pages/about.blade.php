  ...
  <section class="profile section" id="profile">
    <div class="container">
      <div class="row justify-content-md-center">
        ...
        {{-- profile 2 --}}
        <div class="col-md-auto" data-aos="fade-up">
          <div class="card text-white bg-primary mb-3 card-profile" style="width: 18rem;">
        ...
        {{-- profile 3 --}}
        <div class="col-md-auto" data-aos="fade-up">
          <div class="card text-white bg-warning mb-3 card-profile" style="width: 18rem;">
            <img src="{{ url('/images/profile_hamid.png') }}" class="card-img-top" style="" alt="...">
            <div class="card-header text-center">
              Design UI/UX
            </div>
            <div class="card-body">
        ...
        {{-- profile 4 --}}
        <div class="col-md-auto" data-aos="fade-up">
          <div class="card text-white bg-info mb-3 card-profile" style="width: 18rem;">
